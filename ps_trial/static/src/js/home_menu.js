...
HomeMenu.include({
    ...
    _onEnterpriseBuy: function () {
        ...
        this._rpc({
            ...
            .then(function (users) {
                window.location =
                    $.param.querystring("https://www.mypscloud.com/odoo-enterprise/upgrade", {num_users: users});
            });
    },
    /**
     * @private
                    ...
                    .then(function () {
                        $.when(
                            ...
                            if (newDate !== oldDate && mtNewDate > new moment()) {
                                ...
                                window.location =
                                    $.param.querystring("https://www.mypscloud.com/odoo-enterprise/renew", params);
                            }
                        });
                    });
            });
            ...
            .then(function (contract) {
                self._rpc({
                    ...
                    .then(function (users) {
                        ...
                        window.location =
                            $.param.querystring("https://www.mypscloud.com/odoo-enterprise/upsell", params);
                    });
            });
    },
});
